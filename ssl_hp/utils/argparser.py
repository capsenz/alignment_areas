...
def parser():
    ...
    conf_parser.add_argument(
        "-d", "--dataset", default="cifar100", help="use what dataset"
    )
    ...
    parser.add_argument(
        "--num_labeled", type=int, default=5000, help="number of labeled data"
    )
    ...
    parser.add_argument(
        "--prototypes",
        type=str,
        default="prototypes/cifar10_prototypes.npy",
        help="Prototypes to use for method",
    )
