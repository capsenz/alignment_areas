...
class ResNetFMNIST(nn.Module):
    ...
    def __init__(self, depth, output_dims=10, multiplier=1, polars=None):
        ...
        # first arg is usually 3 
        self.conv1 = nn.Conv2d(1, 16 * multiplier, kernel_size=3, padding=1, bias=False)
